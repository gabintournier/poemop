...
<p class="center">* Champs importants pour l'inscription</p>
<h3>Mon profil</h3>
<hr class="separe">
...
?>
	...
	<div class="text-center">
		<input type="submit" class="btn btn-secondary btn-form" name="valider_elec" value="Valider">
	</div>

	<h3>Mon compteur éléctrique</h3>
	<hr class="separe">
	<div class="row">
		<div class="col-sm-6">
			<label for="compteur_puissance" class="col-form-label custom-label">
				Puissance de mon compteur (en kVa) *
			</label>
			<input type="text" class="form-control form-lg" name="compteur_puissance" placeholder="Puissance compteur">
		</div>
		...
		<div class="col-sm-6">
			<label for="compteur_pdl" class="col-form-label custom-label">
				Mon point de livraison PDL (indiqué sur ma facture) *
			</label>
			<input type="text" class="form-control form-lg" name="compteur_pdl" placeholder="Point de livraison">
		</div>
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<label for="compteur_linky" class="col-form-label custom-label">
				J'ai un compteur Linky *
			</label>
			<select class="form-control custom-input form-lg white" name="compteur_linky">
