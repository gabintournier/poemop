...
include_once __DIR__ . "/inc/pmp_inc_fonctions_zones_dev.php";
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-inline">
											...
											<div class="col-sm-8" style="padding:0">
												<input type="text" name="heure_mail" class="form-control" value="10h30" style="width:100%">
											</div>
										</div>
									</div>
...
?>
<script src="js/script_fournisseurs.js" charset="utf-8"></script>
<script src="js/script_zones.js" charset="utf-8"></script>
