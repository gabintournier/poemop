<div class="modal fade" id="AjouterProposee" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" style="max-width: 45%;">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Créer des commandes proposées pour ce groupement ?</h5>
					...
					<div class="col-sm-8">
						<fieldset>
							...
							<div class="form-inline" style="margin: 2% 0 0 0;">
								<label for="choix_sms" class="col-sm-3 col-form-label" style="padding-left:0;">SMS à envoyé</label>
