...
<div class="bloc">
	<div class="menu-bloc">
		...
		<a  href="#" class="active">Groupement possible</a>
		<a href="plusieurs_groupement_possible.php">Plusieurs groupements possible</a>
	</div>
	<form method="post">
...
<?php
							while($commande = mysqli_fetch_array($res_cmd))
							{
								...
								$test = getGroupementCree($co_pmp, $commande["code_postal"]);
								$num_avis = mysqli_num_rows($test);

?>
								<tr>
									<td></td>
									<td><input type="checkbox" name="select_grp" id="select_grp" class="switch value check" style="background: #ddddddd1;"></td>
									...
									<td><?= $status; ?></td>
									<td style="border-left: 1px solid #0b242436;"><?= $commande["libelle"]; ?></td>
								</tr>
<?php
